...
public class MessageAgent extends Agent {
	...
	private String coordinatorName = "Architect@10.0.3.1:1099/JADE";
	private String coordinatorAddress = "http://10.0.3.1:7778";
	...
	public class CreateAgent extends OneShotBehaviour {
		...
		public void action() {
			...
			jade.wrapper.AgentContainer container = rt.createAgentContainer(p);

			for (int counter = 0; counter < noOfAgents; counter++) {

				// AgentController Agent = null;
				try {
					agentList.add(((ContainerController) container).createNewAgent("Smith" + agentCount, "agents.Smith",
							null));
